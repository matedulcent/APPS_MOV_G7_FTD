...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    if (!canSubmit) return;
    await dispatch(loginUser({ email: email.trim().toLowerCase(), password, role }));
  };
...
const styles = StyleSheet.create({
  ...
  indicator: { position: "absolute", top: 0, bottom: 0, width: "50%", backgroundColor: "#2a7091", borderRadius: 25, zIndex: 0 },
  switchButton: { flex: 1, paddingVertical: isWeb ? 10 : height * 0.018, alignItems: "center", zIndex: 1 },
  switchText: { fontSize: isWeb ? 16 : width * 0.04, color: "#555" },
  activeText: { color: "#fff", fontWeight: "bold" },
  input: { flexDirection: "row", alignItems: "center", padding: isWeb ? 14 : width * 0.04, borderRadius: 10, backgroundColor: "#f5f5f5", marginBottom: height * 0.015, borderWidth: 1, borderColor: "#ddd", fontSize: isWeb ? 14 : width * 0.04 },
  errorBox: { alignSelf: "center", backgroundColor: "rgba(255, 0, 0, 0.1)", borderRadius: 8, paddingVertical: 8, paddingHorizontal: 12, marginBottom: 10 },
  errorText: { color: "crimson", fontWeight: "bold", textAlign: "center", fontSize: 15 },
  loginButton: { backgroundColor: "#03a9f4", paddingVertical: isWeb ? 12 : height * 0.02, borderRadius: 12, alignItems: "center", marginBottom: height * 0.025 },
  backButton: { paddingVertical: isWeb ? 10 : height * 0.015, paddingHorizontal: isWeb ? 20 : width * 0.04, borderRadius: 20, alignSelf: "center", justifyContent: "center", backgroundColor: "rgba(255, 255, 255, 0.85)", marginBottom: height * 0.025 },
  backText: { color: "#000000ff", fontSize: isWeb ? 14 : width * 0.04, fontWeight: "bold" },
  loginText: { color: "#fff", fontSize: isWeb ? 18 : width * 0.05, fontWeight: "bold" },
  linkText: { textAlign: "center", color: "#007AFF", marginTop: height * 0.015, fontSize: isWeb ? 14 : width * 0.04 },
});
